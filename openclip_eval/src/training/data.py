...
def get_folder(args, preprocess_fns,is_train,epoch=0,tokenizer=None):

    preprocess_val = preprocess_fns


    data_path = args.down_eval
    preprocess_fn = preprocess_val
    assert data_path
...
def get_dataset_fn(data_path, dataset_type):
    if dataset_type == "webdataset":
        ...
        for name in ["office-home","pacs","vlcs","domainnet"]:
...
def get_data(args, preprocess_fns, epoch=0, tokenizer=None):
    ...
    if args.down_eval:
        data["down-eval"] = get_dataset_fn(args.down_eval, args.dataset_type)(
            args, preprocess_val, is_train=False, tokenizer=tokenizer)
