...
def main(args):
    ...
    if args.lock_image_unlock_gated:
        model.lock_image_tower_unlock_gated()
    if args.lock_text:
    ...
    if 'train' not in data:
        ...
        if 1 :#args.model == "promptstyler":
            ...
            # vlcs : 5, pacs : 7, officehome : 65
            out_features = 5 if 'vlcs' in args.down_eval else 7 if 'pacs' in args.down_eval else 65
            s, m = 5, 0.5
